...
public class RPG_Game {
    ...
    public static void startGame() {
        Boss boss = new Boss("Black", 1500, 50);
        Warrior warrior1 = new Warrior("Rick", 280, 10);
        Warrior warrior2 = new Warrior("Arthur", 270, 15);
        Magic magic = new Magic("Potter", 260, 10, 3);
        Medic doc = new Medic("Haus", 250, 5, 15);
        Medic assistant = new Medic("Levin", 300, 5, 5);
        Berserk berserk = new Berserk("Valera", 240, 10);
        King king = new King("KING", 200);
        Hacker hacker = new Hacker("Anonim", 300, 5, 30);
        Bomb bomb = new Bomb("TNT", 500, 500, 5);

        Hero[] heroes = {warrior1, doc, warrior2, magic, berserk, assistant, king, hacker, bomb};
